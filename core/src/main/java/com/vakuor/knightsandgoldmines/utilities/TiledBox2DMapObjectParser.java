...
import com.vakuor.knightsandgoldmines.utilities.TiledBox2DMapObjectParser.Listener.Adapter;
...
public class TiledBox2DMapObjectParser {
    ...
    public interface Listener {
        ...
        /** @param parser the {@link TiledBox2DMapObjectParser} instance that is going to {@link TiledBox2DMapObjectParser#load(World, Map) process} a map */
        void init(TiledBox2DMapObjectParser parser);
         ...
         *  @author dermetfan */
        class Adapter implements TiledBox2DMapObjectParser.Listener {

            /** does nothing */
            @Override
            public void init(TiledBox2DMapObjectParser parser) {}
    ...
    /** @see TiledBox2DMapObjectParser.Aliases */
    private TiledBox2DMapObjectParser.Aliases aliases = new TiledBox2DMapObjectParser.Aliases();

    /** the {@link TiledBox2DMapObjectParser.Listener} used by default (an {@link Adapter} instance) */
    public static final Adapter defaultListener = new Adapter();

    /** the {@link TiledBox2DMapObjectParser.Listener} to use ({@link #defaultListener} by default) */
    private TiledBox2DMapObjectParser.Listener listener = defaultListener;

    /** the unit scale to convert from editor units to Box2D meters */
    private float unitScale = 1;

    /** if the {@link TiledBox2DMapObjectParser.Aliases#unitScale unit scale} found in the map should be ignored */
    private boolean ignoreMapUnitScale;

    /** if the {@link TiledBox2DMapObjectParser.Aliases#unitScale unit scale} found in the layers should be ignored */
    ...
    /** creates a new {@link TiledBox2DMapObjectParser} with the default {@link TiledBox2DMapObjectParser.Aliases} */
    public TiledBox2DMapObjectParser() {}

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Aliases}
     *  @param aliases the {@link #aliases} to use */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Aliases aliases) {
        this.aliases = aliases;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Listener}
     *  @param listener the {@link #listener} to use */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Listener listener) {
        this.listener = listener;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Aliases} and {@link TiledBox2DMapObjectParser.Listener}
     *  @param aliases the {@link #aliases}
     *  @param listener the {@link #listener} */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Aliases aliases, TiledBox2DMapObjectParser.Listener listener) {
        this.aliases = aliases;
        this.listener = listener;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Aliases}, {@link #tileWidth} and {@link #tileHeight}
     *  @param aliases the {@link #aliases}
     *  @param tileWidth the {@link #tileWidth}
     *  @param tileHeight the {@link #tileHeight} */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Aliases aliases, float tileWidth, float tileHeight) {
        this.aliases = aliases;
        this.tileWidth = tileWidth;
        this.tileHeight = tileHeight;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Listener}, {@link #tileWidth} and {@link #tileHeight}
     *  @param listener the {@link #listener}
     *  @param tileWidth the {@link #tileWidth}
     *  @param tileHeight the {@link #tileHeight} */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Listener listener, float tileWidth, float tileHeight) {
        this.listener = listener;
        this.tileWidth = tileWidth;
        this.tileHeight = tileHeight;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Listener}, {@link TiledBox2DMapObjectParser.Aliases}, {@link #tileWidth} and {@link #tileHeight}
     *  @param aliases the {@link #aliases}
     *  @param listener the {@link #listener}
     *  @param tileWidth the {@link #tileWidth}
     *  @param tileHeight the {@link #tileHeight} */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Aliases aliases, TiledBox2DMapObjectParser.Listener listener, float tileWidth, float tileHeight) {
        this.aliases = aliases;
        this.listener = listener;
        this.tileWidth = tileWidth;
        this.tileHeight = tileHeight;
    ...
    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link #unitScale unitScale} and sets {@link #ignoreMapUnitScale} to true
     *  @param unitScale the {@link #unitScale unitScale} to use */
    public TiledBox2DMapObjectParser(float unitScale) {
        this.unitScale = unitScale;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link #unitScale}, {@link #tileWidth}, {@link #tileHeight} and sets {@link #ignoreMapUnitScale} to true
    ...
    public TiledBox2DMapObjectParser(float unitScale, float tileWidth, float tileHeight) {
        this.unitScale = unitScale;
        this.tileWidth = tileWidth;
        this.tileHeight = tileHeight;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Aliases} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
     *  @param aliases the {@link #aliases} to use
     *  @param unitScale the {@link #unitScale} to use */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Aliases aliases, float unitScale) {
        this.aliases = aliases;
        this.unitScale = unitScale;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Listener} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
     *  @param listener the {@link #listener} to use
     *  @param unitScale the {@link #unitScale} to use */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Listener listener, float unitScale) {
        this.listener = listener;
        this.unitScale = unitScale;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} using the given {@link TiledBox2DMapObjectParser.Aliases}, {@link TiledBox2DMapObjectParser.Listener} and {@link #unitScale} and sets {@link #ignoreMapUnitScale} to true
     *  @param aliases the {@link #aliases} to use
     *  @param listener the {@link #listener} to use
     *  @param unitScale the {@link #unitScale} to use */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Aliases aliases, TiledBox2DMapObjectParser.Listener listener, float unitScale) {
        this.aliases = aliases;
        this.listener = listener;
        this.unitScale = unitScale;
    }

    /** creates a new {@link TiledBox2DMapObjectParser} with the given parameters and sets {@link #ignoreMapUnitScale} to true
     *  @param aliases the {@link #aliases} to use
     *  @param unitScale the {@link #unitScale unitScale} to use
     *  @param tileWidth the {@link #tileWidth} to use
     *  @param tileHeight the {@link #tileHeight} to use */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Aliases aliases, float unitScale, float tileWidth, float tileHeight) {
        this.aliases = aliases;
        this.unitScale = unitScale;
     ...
     *  @param tileWidth the {@link #tileWidth} to use
     *  @param tileHeight the {@link #tileHeight} to use */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Listener listener, float unitScale, float tileWidth, float tileHeight) {
        this.listener = listener;
        this.unitScale = unitScale;
        ignoreMapUnitScale = true;
        this.tileWidth = tileWidth;
     ...
     *  @param tileWidth the {@link #tileWidth} to use
     *  @param tileHeight the {@link #tileHeight} to use */
    public TiledBox2DMapObjectParser(TiledBox2DMapObjectParser.Listener listener, TiledBox2DMapObjectParser.Aliases aliases, float unitScale, float tileWidth, float tileHeight) {
        this.aliases = aliases;
        this.listener = listener;
        this.unitScale = unitScale;
        ignoreMapUnitScale = true;
    ...
    public Fixture createFixture(MapObject mapObject, Body body) {
        ...
        if(mapObject instanceof TiledMapTileMapObject) {
            ...
            tile = ((TiledMapTileMapObject) mapObject).getTile();
            Rectangle rectangle = new Rectangle(((TiledMapTileMapObject) mapObject).getX(),((TiledMapTileMapObject) mapObject).getY(),((TiledMapTileMapObject) mapObject).getTile().getTextureRegion().getRegionWidth(),((TiledMapTileMapObject) mapObject).getTile().getTextureRegion().getRegionHeight());
        ...
        MapProperties properties = mapObject.getProperties();
        if(tile!=null) {properties.put("tile",tile.getId()-1);}
    ...
    /** @param heritage the MapProperties in which to search for an {@link TiledBox2DMapObjectParser.Aliases#body} property
    ...
    public void reset() {
        aliases = new TiledBox2DMapObjectParser.Aliases();
    ...
    /** @return the {@link TiledBox2DMapObjectParser.Aliases} */
    public TiledBox2DMapObjectParser.Aliases getAliases() {
        return aliases;
    }

    /** @param aliases the {@link TiledBox2DMapObjectParser.Aliases} to set */
    public void setAliases(TiledBox2DMapObjectParser.Aliases aliases) {
        this.aliases = aliases;
    }

    /** @return the {@link #listener} */
    public TiledBox2DMapObjectParser.Listener getListener() {
        return listener;
    }

    /** @param listener the {@link #listener} to set */
    public void setListener(TiledBox2DMapObjectParser.Listener listener) {
