...
public class MapBodyBuilder {
    ...
    public static Array<Body> buildShapes(TiledMap map, float pixels, World world) {
        ...
        //TiledMapTileMapObject tileobject = new TiledMapTileMapObject(map.getTileSets().getTileSet("tileset").getTile());


        MapObjects objects = map.getLayers().get("Obstacles").getObjects();
        TiledMapTileMapObjects tileMapObjects = new TiledMapTileMapObjects();

        Array<TiledMapTileMapObject> objarr;
        //tileobject.

        for(TiledMapTileMapObject obj : tileMapObjects)
